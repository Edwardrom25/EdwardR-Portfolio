      ...
      <div className="container freudenberg-page">
        <div className="text-zone">
          ...
          <ul>
            ...
            <li>Developed 2D SolidWorks drawings for six parts of a flagship product launching in 2025, ensuring precise dimensions and tolerances in connection areas to minimize assembly issues for end users</li>
